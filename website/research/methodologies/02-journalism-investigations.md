...
### Evidence Hierarchy
- **[Legal eDiscovery](./03-legal-ediscovery.md#evidence-authentication-and-chain-of-custody)** - FRE 902 self-authenticating records, hash certification
...
- **[Regulatory Investigations](./04-regulatory-investigations.md#evidence-types-and-hierarchy)** - Documentary evidence hierarchy in professional standards cases
...
- **[Academic Research](./06-academic-research.md#quality-assessment-frameworks)** - Source triangulation and methodological rigor assessment
- **[Police Investigations](./01-police-investigations.md#interview-methodologies)** - Cognitive Interview technique for witness reliability

### Multi-Document Analysis
- **[Legal eDiscovery](./03-legal-ediscovery.md#multi-document-analysis-and-orchestration)** - TAR 2.0/CAL for massive document review (Panama Papers scale)
- **[Academic Research](./06-academic-research.md#systematic-review-methodologies)** - PRISMA protocol for systematic document screening
- **[Intelligence Analysis](./05-intelligence-analysis.md#multi-source-intelligence-fusion)** - Decision-level fusion for contradictory sources
...
- **[Regulatory Investigations](./04-regulatory-investigations.md#quality-assurance-mechanisms)** - Independent dual decision-makers

### Temporal Analysis
- **[Legal eDiscovery](./03-legal-ediscovery.md#timeline-construction)** - 8-step timeline construction with Bates linking
- **[Police Investigations](./01-police-investigations.md#core-investigation-framework)** - 5WH framework (When as critical dimension)
- **[Intelligence Analysis](./05-intelligence-analysis.md#diagnostic-techniques)** - Chronologies for pattern detection and gap identification

### Network Analysis
- **[Legal eDiscovery](./03-legal-ediscovery.md#communication-network-analysis)** - Email network metrics (betweenness centrality, community detection)
- **[Intelligence Analysis](./05-intelligence-analysis.md#multi-source-intelligence-fusion)** - Entity relationship mapping across INT types
- **[Academic Research](./06-academic-research.md#qualitative-data-analysis)** - Framework Method for thematic network visualization
...
### 7.5 Legal and Ethical Documentation
...
### Appendix C: Resource Quick Links

**Training:**
- GIJN Resource Center: https://gijn.org/resources
- IRE Resource Center: https://ire.org/resource-center
- Knight Center MOOCs: https://journalismcourses.org
...
- Tabula (PDF tables): https://tabula.technology

**Security:**
- EFF Surveillance Self-Defense: https://ssd.eff.org
- CPJ Security Guide: https://cpj.org/safety-kit
- SecureDrop: https://securedrop.org
- Signal: https://signal.org

**Verification:**
- Verification Handbook: https://firstdraftnews.org/long-form-article/verification-handbook
- InVID Verification Plugin: https://invid-project.eu/tools-and-services/invid-verification-plugin/

**Legal:**
- Reporters Committee: https://rcfp.org
- FOI Resources: https://ire.org/foi

**Organizations:**
- ICIJ: https://icij.org
- OCCRP: https://occrp.org
...
**Prepared For:** Phronesis FCIP / Apatheia Labs
**Framework Alignment:** S.A.M. (Systematic Adversarial Methodology)
