  ...
  documents: new Map([
    [
      'mock-police',
      {
        ...
        extracted_text:
          'Police report contents: Incident on 12/01/2023. Officers attended. Mother appeared intoxicated. Child was distressed.',
        status: 'completed',
      },
    ],
    [
      'mock-sw',
      {
        ...
        extracted_text:
          'Social Work Assessment. Concerns raised regarding alcohol use. Mother denies issues. Child placement recommended.',
        status: 'completed',
      },
    ],
    [
      'mock-expert',
      {
        ...
        extracted_text:
          'Psychological Assessment. I have read the police report. I find the mother avoids the truth. I recommend therapy.',
        status: 'completed',
      },
    ],
  ]),
  cases: new Map([['PE23C50095', { id: 'PE23C50095', name: 'Smith vs Jones', status: 'active' }]]),
  findings: new Map(),
}
