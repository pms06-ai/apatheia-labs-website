  ...
  findings: [
    ...
    },
    {
      ...
      evidence: {
        ...
        sourceContent:
          'While there were initial concerns about hygiene, these have been largely addressed...',
    ...
    // Expert Witness Findings
    {
      ...
      description:
        'Expert ventured beyond the instructed area of expertise (Psychology) into Fact Finding.',
      severity: 'high',
      document_ids: ['mock-expert'],
      evidence: {
        violationType: 'scope_exceedance',
        details:
          'Expert made definitive statements about factual events witnesses did not observe.',
      },
    ...
    // Coordination Findings
    {
      ...
      description:
        'High degree of linguistic similarity between purportedly independent reports, suggesting copying.',
      severity: 'critical',
      document_ids: ['mock-police', 'mock-sw'],
      evidence: {
        similarityScore: 0.92,
        sharedPhrases: [
          'mother presented as hostile and uncooperative',
            ...
            return (table: string) => ({
              select: (columns: string = '*') => {
                ...
                const chain = {
                  ...
                  single: () =>
                    Promise.resolve({ data: (MOCK_DATA as any)[table]?.[0] || null, error: null }),
