  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'border border-charcoal-700 bg-bg-elevated shadow-2xl',
        'rounded-xl',
        'duration-200',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          ...
          'ring-offset-bg-elevated transition-opacity',
          'hover:opacity-100',
          'focus:outline-none focus:ring-2 focus:ring-bronze-600 focus:ring-offset-2',
          'disabled:pointer-events-none',
          'data-[state=open]:bg-charcoal-700 data-[state=open]:text-charcoal-300',
          'text-charcoal-400'
        )}
      >
        <X className="h-4 w-4" />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      'text-lg font-semibold leading-none tracking-tight text-charcoal-50',
      className
    )}
    {...props}
  />
